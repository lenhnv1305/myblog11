...
<body>
  <div class='container'>
        ...
        <ul class="nav">
            ...
            <li class=""><a href="index.php?c=cuahang&m=home">Cửa hàng</a></li>
             ...
             foreach ($_SESSION['GioHang'] as $sanpham){
                $tongSP = $tongSP + $sanpham->getSoLuong();
             }
             ?>
            ...
            <li><a href="index.php?c=cuahang&m=xemgiohang" > (<?php echo $tongSP;?>)<i class="fa fa-opencart"></i></a></li>
    ...
    <div id='content' class='row-fluid'>
        <div class='span2'>
            <?php include ROOT . DS . 'views' . DS . 'blocks' . DS.'danhmuc.php'?>
        </div>
